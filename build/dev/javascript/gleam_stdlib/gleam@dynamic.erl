...
-spec optional(fun((dynamic_()) -> {ok, DCM} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(DCM)} |
    {error, list(decode_error())}).
optional(Decode) ->
...
-spec any(list(fun((dynamic_()) -> {ok, DGM} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        DGM} |
    {error, list(decode_error())}).
any(Decoders) ->
...
-spec result(
    ...
    fun((dynamic_()) -> {ok, DCC} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, DCA} | {error, DCC}} |
    {error, list(decode_error())}).
...
-spec list(fun((dynamic_()) -> {ok, DCH} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(DCH)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-spec map_errors(
    {ok, DAV} | {error, list(decode_error())},
...
-spec field(
    any(),
    fun((dynamic_()) -> {ok, DCW} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DCW} | {error, list(decode_error())}).
...
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, DDA} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(DDA)} |
    {error, list(decode_error())}).
...
-spec element(
    integer(),
    fun((dynamic_()) -> {ok, DDI} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DDI} | {error, list(decode_error())}).
...
-spec tuple2(
    fun((dynamic_()) -> {ok, DEI} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DEK} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DEI, DEK}} | {error, list(decode_error())}).
...
-spec tuple3(
    fun((dynamic_()) -> {ok, DEN} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DEP} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DER} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DEN, DEP, DER}} | {error, list(decode_error())}).
...
-spec tuple4(
    fun((dynamic_()) -> {ok, DEU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DEW} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DEY} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFA} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DEU, DEW, DEY, DFA}} |
    {error, list(decode_error())}).
...
-spec tuple5(
    fun((dynamic_()) -> {ok, DFD} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFF} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFH} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFJ} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFL} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DFD, DFF, DFH, DFJ, DFL}} |
    {error, list(decode_error())}).
...
-spec tuple6(
    ...
    fun((dynamic_()) -> {ok, DFS} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFU} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFW} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DFY} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {DFO, DFQ, DFS, DFU, DFW, DFY}} |
    {error, list(decode_error())}).
...
-spec map(
    fun((dynamic_()) -> {ok, DGB} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DGD} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@map:map_(DGB, DGD)} |
    {error, list(decode_error())}).
...
-spec decode5(
    fun((DHS, DHT, DHU, DHV, DHW) -> DHX),
    fun((dynamic_()) -> {ok, DHS} | {error, list(decode_error())}),
    ...
    fun((dynamic_()) -> {ok, DHW} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, DHX} | {error, list(decode_error())}).
...
-spec decode6(
    fun((DIE, DIF, DIG, DIH, DII, DIJ) -> DIK),
    fun((dynamic_()) -> {ok, DIE} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, DIF} | {error, list(decode_error())}),
...
-spec decode7(
    fun((DIS, DIT, DIU, DIV, DIW, DIX, DIY) -> DIZ),
...
-spec decode8(
    fun((DJI, DJJ, DJK, DJL, DJM, DJN, DJO, DJP) -> DJQ),
    ...
    fun((dynamic_()) -> {ok, DJP} | {error, list(decode_error())})
...
-spec decode9(
    fun((DKA, DKB, DKC, DKD, DKE, DKF, DKG, DKH, DKI) -> DKJ),
